...
#line 28 "D:\\Max\\WEMOS\\PC_on-off\\PC_on-off.ino"
void setup();
#line 72 "D:\\Max\\WEMOS\\PC_on-off\\PC_on-off.ino"
void loop();
#line 114 "D:\\Max\\WEMOS\\PC_on-off\\PC_on-off.ino"
void newMsg(FB_msg &msg);
#line 250 "D:\\Max\\WEMOS\\PC_on-off\\PC_on-off.ino"
void connectWiFi();
#line 286 "D:\\Max\\WEMOS\\PC_on-off\\PC_on-off.ino"
void saveData();
#line 307 "D:\\Max\\WEMOS\\PC_on-off\\PC_on-off.ino"
void loadData();
#line 335 "D:\\Max\\WEMOS\\PC_on-off\\PC_on-off.ino"
void deleteJSON(String jsonFile);
#line 358 "D:\\Max\\WEMOS\\PC_on-off\\PC_on-off.ino"
...
String textMenu(String menu)
{
  ...
  if (menu == "start")
  {
    text = "Увімкнути \t  Вимкнути \n Аптайм \t Стан \t Ресет";
  }
  else if (menu == "wifi")
  {
    text = "Переглянути Log";
  }

  else
  {
    text = "невідома команда для меню";
  }
